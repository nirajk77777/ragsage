...
([ADR-0001](https://github.com/nirajk77777/ragsage/blob/main/docs/adr/0001-heuristic-parser-replaces-docling.md)),
which buys portability at a cost in fidelity. The weak spots are written down rather than left to
be discovered:
[**docs/failure-modes.md**](https://github.com/nirajk77777/ragsage/blob/main/docs/failure-modes.md)
