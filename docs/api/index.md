...
| Page | What's in it |
|---|---|
| [Façades](facades.md) | The four entry points: ingest, query, evaluate, and the assembler over all of them. |
| [Ports](ports.md) | The thirteen `Protocol`s every adapter conforms to. |
| [Models](models.md) | The domain data — documents, chunks, answers, citations, scope. |
| [Configuration](configuration.md) | The frozen dataclasses you construct and pass in. |
| [Adapters](adapters.md) | What ships in the box: the heuristic parser, Voyage/OpenAI, Postgres, and the fakes. |
