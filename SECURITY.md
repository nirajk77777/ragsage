...
- **Supply chain.** Releases publish through PyPI
  ...
  [docs/releasing.md](https://ragsage.readthedocs.io/en/latest/releasing.html).
...
- **Answer quality, hallucination and retrieval misses.** Ordinary bugs — file them as
  issues. See
  [failure modes](https://ragsage.readthedocs.io/en/latest/failure-modes.html) for the
